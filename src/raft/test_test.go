...
func TestBackup2B(t *testing.T) {
	...
	fmt.Printf("Disconnect servers %d, %d, %d\n", (leader1+2)%servers,
	...
	cfg.disconnect((leader1 + 1) % servers)
	fmt.Printf("Disconnect servers %d, %d\n", (leader1+0)%servers,
		(leader1+1)%servers)
	...
	fmt.Printf("Reconnect servers %d, %d, %d\n", (leader1+2)%servers,
		(leader1+3)%servers, (leader1+4)%servers)
	...
	fmt.Printf("Disconnect servers %d\n", other)
